    ...
    <Layout>
      <Container maxW="6xl" className={styles.policy}>
        ...
        <Box>
          ...
          information depending on how you interact with deinlog.com and the
        ...
        <Box>
          The easiest way to exercise your rights is by sending us an email at{" "}
          <strong>info@deinlog.com</strong>. We will consider and act upon any
          request in accordance with applicable data protection laws.
        </Box>
        <Box>
          Want to learn more about what deinlog.com does with any information we
          collect? Click{" "}
          <Link as={NextLink} href="#toc">
            here
          </Link>{" "}
        ...
        <Box>
          <Box as="i">
            <Box as="b">In Short:</Box> We collect personal information that you
            provide to us.
          </Box>
        </Box>
        <Box>
        ...
        <Box>
          <Box as="b">Personal Information Provided by You.</Box> The personal
        ...
        <Box>
          <Box as="b">Sensitive Information.</Box> We do not process sensitive
          information.
        </Box>
        <Box>
          <Box as="b">Social Media Login Data.</Box> We may provide you with the
          option to register with us using your existing social media account
          details, like your Facebook, Google, or other social media account. If
        ...
        <Box>
          <Box as="i">
            <Box as="b">In Short:</Box> Some information — such as your Internet
        ...
        <Box>
          <Box as="i">
            <Box as="b">In Short:</Box> We process your information to provide,
          ...
          <UnorderedList>
            ...
            <ListItem>
              To save or protect an individual vital interest. We may process
              your information when necessary to save or protect an individual
        ...
        <Box as="i">
          <Box as="b">In Short:</Box> If you choose to register or log in to our
        ...
        <Box as="i">
          <Box as="b">In Short:</Box> We keep your information for as long as
        ...
        <Box as="i">
          ...
          information through a system of organisational and technical security
          measures.
        </Box>
        <Box>
        ...
        <Box id="withdrawconsent">
          <Box as="b">Withdrawing your consent:</Box> If we are relying on your
        ...
        <Box>
          ...
          email us at <strong>info@deinlog.com</strong>.
        </Box>
        ...
        <Box as="i">
          <Box as="b">In Short:</Box> Yes, if you are a resident of California,
        ...
        <Box>
          <Box as="b">How do we use and share your personal information?</Box>
        </Box>
        <Box>
          ...
          details at the bottom of this document. If you are using an authorised
          agent to exercise your right to opt out we may deny a request if the
          authorised agent does not submit proof that they have been validly
          authorised to act on your behalf.
        </Box>
        <Box>
          <Box as="b">Will your information be shared with anyone else?</Box>
        </Box>
        <Box>
          ...
          deinlog.com has not disclosed, sold, or shared any personal
          information to third parties for a business or commercial purpose in
          the preceding twelve (12) months. deinlog.com will not sell or share
        ...
        <Box>
          <Box as="b">In Short: </Box> Yes, if you are a resident of Virginia,
          you may be granted specific rights regarding access to and use of your
          personal information.
        </Box>
        <Box>
        ...
        <Box>
          Under the Virginia Consumer Data Protection Act (CDPA): Consumer means
          ...
          person acting in a commercial or employment context. Personal data
          ...
          include de-identified data or publicly available information. Sale of
          personal data means the exchange of personal data for monetary
          consideration. If this definition consumer applies to you, we must
          ...
          depending on how you interact with deinlog.com and our Services. To
        ...
        <Box>
          ...
          business or commercial purposes. deinlog.com will not sell personal
        ...
        <Box>
          More information about our data collection and sharing practices can
          be found in this privacy notice. You may contact us by email at{" "}
          <strong>info@deinlog.com</strong>, by visiting http://www.deinlog.com,
        ...
        <Box>
          ...
          necessary to verify you and your consumer request. If you submit the
        ...
        <Box>
          ...
          decision, please email us at info@deinlog.com. Within sixty (60) days
        ...
        <Box>
          ...
          at <strong>info@deinlog.com</strong>
        </Box>
